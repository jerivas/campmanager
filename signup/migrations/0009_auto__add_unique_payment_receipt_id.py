...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Payment', fields ['receipt_id']
        db.create_unique(u'signup_payment', ['receipt_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Payment', fields ['receipt_id']
        db.delete_unique(u'signup_payment', ['receipt_id'])
