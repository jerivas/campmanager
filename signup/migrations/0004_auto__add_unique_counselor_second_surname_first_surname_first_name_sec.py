...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Counselor', fields ['second_surname', 'first_surname', 'first_name', 'second_name']
        db.create_unique(u'signup_counselor', ['second_surname', 'first_surname', 'first_name', 'second_name'])

        # Adding unique constraint on 'Camper', fields ['second_surname', 'first_surname', 'first_name', 'second_name']
        db.create_unique(u'signup_camper', ['second_surname', 'first_surname', 'first_name', 'second_name'])

        # Adding unique constraint on 'Guest', fields ['second_surname', 'first_surname', 'first_name', 'second_name']
        db.create_unique(u'signup_guest', ['second_surname', 'first_surname', 'first_name', 'second_name'])

        # Adding unique constraint on 'Parent', fields ['second_surname', 'first_surname', 'first_name', 'second_name']
        db.create_unique(u'signup_parent', ['second_surname', 'first_surname', 'first_name', 'second_name'])


    def backwards(self, orm):
        # Removing unique constraint on 'Parent', fields ['second_surname', 'first_surname', 'first_name', 'second_name']
        db.delete_unique(u'signup_parent', ['second_surname', 'first_surname', 'first_name', 'second_name'])

        # Removing unique constraint on 'Guest', fields ['second_surname', 'first_surname', 'first_name', 'second_name']
        db.delete_unique(u'signup_guest', ['second_surname', 'first_surname', 'first_name', 'second_name'])

        # Removing unique constraint on 'Camper', fields ['second_surname', 'first_surname', 'first_name', 'second_name']
        db.delete_unique(u'signup_camper', ['second_surname', 'first_surname', 'first_name', 'second_name'])

        # Removing unique constraint on 'Counselor', fields ['second_surname', 'first_surname', 'first_name', 'second_name']
        db.delete_unique(u'signup_counselor', ['second_surname', 'first_surname', 'first_name', 'second_name'])
