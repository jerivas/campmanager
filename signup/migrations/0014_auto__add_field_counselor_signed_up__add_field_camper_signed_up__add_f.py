...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Counselor.signed_up'
        db.add_column(u'signup_counselor', 'signed_up',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Camper.signed_up'
        db.add_column(u'signup_camper', 'signed_up',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Guest.signed_up'
        db.add_column(u'signup_guest', 'signed_up',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Counselor.signed_up'
        db.delete_column(u'signup_counselor', 'signed_up')

        # Deleting field 'Camper.signed_up'
        db.delete_column(u'signup_camper', 'signed_up')

        # Deleting field 'Guest.signed_up'
        db.delete_column(u'signup_guest', 'signed_up')
    ...
    models = {
        ...
        u'signup.camper': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lawyer': ('django.db.models.fields.CharField', [], {'max_length': '16', 'blank': 'True'}),
            ...
            'permission_status': ('django.db.models.fields.IntegerField', [], {'default': '0', 'max_length': '1'}),
