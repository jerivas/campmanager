...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Camper.permission_status'
        db.add_column(u'signup_camper', 'permission_status',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Camper.permission_status'
        db.delete_column(u'signup_camper', 'permission_status')
