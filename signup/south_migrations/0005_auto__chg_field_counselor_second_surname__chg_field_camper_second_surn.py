...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Payment.receipt_id'
        db.alter_column(u'signup_payment', 'receipt_id', self.gf('django.db.models.fields.CharField')(max_length=16, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Counselor.second_surname'
        db.alter_column(u'signup_counselor', 'second_surname', self.gf('django.db.models.fields.CharField')(default='DEFAULT', max_length=64))

        # Changing field 'Camper.second_surname'
        db.alter_column(u'signup_camper', 'second_surname', self.gf('django.db.models.fields.CharField')(default='DEFAULT', max_length=64))

        # Changing field 'Payment.receipt_id'
        db.alter_column(u'signup_payment', 'receipt_id', self.gf('django.db.models.fields.CharField')(default='000', max_length=16))

        # Changing field 'Guest.second_surname'
        db.alter_column(u'signup_guest', 'second_surname', self.gf('django.db.models.fields.CharField')(default='DEFAULT', max_length=64))

        # Changing field 'Parent.second_surname'
        db.alter_column(u'signup_parent', 'second_surname', self.gf('django.db.models.fields.CharField')(default='DEFAULT', max_length=64))
    ...
    models = {
        ...
        u'signup.camper': {
            ...
            'second_surname': ('django.db.models.fields.CharField', [], {'max_length': '64', 'null': 'True', 'blank': 'True'}),
        ...
        u'signup.payment': {
            ...
            'receipt_id': ('django.db.models.fields.CharField', [], {'max_length': '16', 'null': 'True', 'blank': 'True'})
        }
    }
