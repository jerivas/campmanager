...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Counselor.generation'
        db.alter_column(u'signup_counselor', 'generation', self.gf('django.db.models.fields.PositiveIntegerField')(default=1, max_length=1))

        # Changing field 'Camper.generation'
        db.alter_column(u'signup_camper', 'generation', self.gf('django.db.models.fields.PositiveIntegerField')(default=1, max_length=1))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Counselor.generation'
        db.alter_column(u'signup_counselor', 'generation', self.gf('django.db.models.fields.PositiveIntegerField')(max_length=1, null=True))

        # Changing field 'Camper.generation'
        db.alter_column(u'signup_camper', 'generation', self.gf('django.db.models.fields.PositiveIntegerField')(max_length=1, null=True))
