...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Camper.special_case'
        db.delete_column(u'signup_camper', 'special_case')


    def backwards(self, orm):
        # Adding field 'Camper.special_case'
        db.add_column(u'signup_camper', 'special_case',
