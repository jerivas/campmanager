        ...
        if self.birth_date is not None:
            try:
                ...
                birthday = self.birth_date.replace(
                    year=now().year, day=self.birth_date.day - 1
                )
...
class Minor(models.Model):
    ...
    registrar_title = models.CharField(
        _("Birth Certificate Registrar Title"),
        max_length=16,
        blank=True,
        choices=TITLES,
    )
    registrar_position = models.CharField(
        _("Birth Certificate Registrar Position"),
        max_length=100,
        blank=True,
...
class Parent(SiteRelated, Person, ExtendedInfo):
    ...
    def autocomplete_search_fields():
        ...
        return (
            ...
            "second_name__icontains",
            "first_surname__icontains",
            "second_surname__icontains",
        )
...
class Counselor(SiteRelated, Person, Payer, Attendant, Member):
    ...
    def autocomplete_search_fields():
        ...
        return (
            "first_name__icontains",
            "first_surname__icontains",
            "badge_name__icontains",
            "small_group__title__icontains",
        )
