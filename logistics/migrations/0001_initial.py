...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'logistics_smallgroup', (
            ...
            ('bus', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['logistics.Bus'], null=True, blank=True)),
        ))
        db.send_create_signal(u'logistics', ['SmallGroup'])

        # Adding model 'Cabin'
        db.create_table(u'logistics_cabin', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=32)),
        ))
        db.send_create_signal(u'logistics', ['Cabin'])

        # Adding model 'Bus'
        db.create_table(u'logistics_bus', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('responsible', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['signup.Counselor'], unique=True, null=True, blank=True)),
        ))
        db.send_create_signal(u'logistics', ['Bus'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'Cabin'
        db.delete_table(u'logistics_cabin')

        # Deleting model 'Bus'
        db.delete_table(u'logistics_bus')
