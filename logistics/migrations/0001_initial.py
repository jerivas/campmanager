    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('generation', models.PositiveIntegerField(default=1, max_length=1, verbose_name='Generation', choices=[(1, 'Josías 1'), (2, 'Josías 2'), (3, 'Freshmen'), (4, 'Sophomores'), (5, 'Juniors'), (6, 'Seniors')])),
